layui.use(['form','layer','laydate','table','laytpl'],function () {
    ...
    var roleTable = table.render({
        ...
        cols : [[
            ...
            {field: 'route_name', title: '权限地址', width:220},
            {field: 'uri', title: '路由地址', width:220},
            {field: 'is_menu', title: '是否显示菜单',align:'center' ,width:120,templet:function (d) {
                    var checked='';
                    if (d.is_menu==1){checked='checked'}
                    return '<input type="checkbox" name="is_menu" value="'+d.id+'" lay-filter="is_menu" lay-skin="switch" lay-text="是|否" '+checked+'>'
                }},
            {field: 'desc', title: '权限描述', width:220},
            {field: 'status', title: '是否正常', align:'center',width:100,align:'center' , templet:function(d){
                    var checked='';
