...
<script>
    var roleIndexUrl ="{{route('permission.index')}}",//列表数据
        roleChangeStatusUrl="{{route('permission.status')}}",
        roleDelUrl = "{{route('permission.roleDel')}}",
        roleAddUrl = "{{route('permission.add')}}",
        roleSaveUrl = "{{route('permission.save')}}"
        roleDelAllUrl = "{{route('permission.delAll')}}"
...
<script type="text/javascript" src="{{asset('zng/assets/js/admin/permission.js')}}"></script>
